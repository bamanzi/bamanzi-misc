...
;;; Synched up with: Mostly with GNU Emacs 21.2.  The differences are a
;;; couple of defcustom<->defvars, we use `tcl-imenu-generic-expression'
;;; instead of `tcl-imenu-create-index-function' and some typo fixes.
